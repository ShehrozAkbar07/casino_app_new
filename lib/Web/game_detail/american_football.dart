...
class AmericanFootball extends StatefulWidget {
  const AmericanFootball({super.key});

  @override
  State<AmericanFootball> createState() => _AmericanFootballState();
}

class _AmericanFootballState extends State<AmericanFootball>
