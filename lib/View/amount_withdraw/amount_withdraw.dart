...
class AmountWithdraw extends StatefulWidget {
  const AmountWithdraw({super.key});

  @override
  State<AmountWithdraw> createState() => _AmountWithdrawState();
}

class _AmountWithdrawState extends State<AmountWithdraw> {
  @override
