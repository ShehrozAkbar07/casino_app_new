            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  categoryrow('Sport Jackspot', 'viewall', context,
                      CategoryDetail(categoryName: 'Sport Jackspot')),
                  SizedBox(
                    height: 20.h,
                  ),
                  SizedBox(
                  ...
                  categoryrow('Sport Roulette', 'viewall', context,
                      CategoryDetail(categoryName: 'Sport Roulette')),
                  SizedBox(
                    height: 20.h,
                  ),
                  SizedBox(
                  ...
                  categoryrow('Game Slot', 'viewall', context,
                      CategoryDetail(categoryName: 'Game Slot')),
                  SizedBox(
                    height: 20.h,
                  ),
                  SizedBox(
